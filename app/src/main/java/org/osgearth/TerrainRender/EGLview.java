...
public class EGLview extends GLSurfaceView {
	...
	//touch listener used by zoom function
	...
	private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
	    ...
	    //use 1.x rendering
		//minimal size of red/green/blue color is 4 bits
	...
	private static class Renderer implements GLSurfaceView.Renderer {
		...
		public void onDrawFrame(GL10 gl) {
			//set elgInit to true, so sensor functions can call JNI
			NativeViewer.eglInit = true;
	        osgNativeLib.step();
	    }
